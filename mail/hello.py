...
app.config['MAIL_USERNAME'] = '602632139@qq.com'  # 填邮箱
app.config['MAIL_PASSWORD'] = 'lzolocyxmzspbcaa'      # 填授权码
app.config['MAIL_DEFAULT_SENDER'] = '602632139@qq.com'  # 填邮箱，默认发送者
manager = Manager(app)
mail = Mail(app)
...
def index():
    msg = Message(subject='Hello World',
                  sender="602632139@qq.com",  # 需要使用默认发送者则不用填
                  recipients=['1463240586@qq.com'])
